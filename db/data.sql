...
VALUES (1, 'Test1', 'McTest1'), (2, 'Test2', 'McTest2'), (3, 'Test3', 'McTest3'), (4, 'Test4', 'McTest4');
...
INSERT INTO `Orders`
VALUES (2, 'Queued', 1, 1), (3, 'Queued', 1, 2), (4, 'Queued', 1, 3), (5, 'InProgress', 2, 3), (6, 'InProgress', 2, 4), (7, 'InProgress', 3, 1), (8, 'QA', 1, 2), (9, 'Complete', 1, 3), (10, 'Cancelled', 4, 1), (11, 'Cancelled', 5, 2);
...
VALUES (
        1,
        'Hat',
        'https://i.ibb.co/85GGy5t/ryan-hoffman-2-BK0-JEw-QSp-Q-unsplash.jpg',
        'Active'
    ), (
        2,
        'Shoes',
        'https://i.ibb.co/VVcbfnT/shoe.jpg',
        'Active'
    ), (
        3,
        'Pants',
        'https://i.ibb.co/23PF5Sd/pant.jpg',
        'Active'
    ), (
        4,
        'Shirt',
        'https://i.ibb.co/Gspv7y3/shirt.jpg',
        'InActive'
    ), (
        5,
        'Coat',
        'https://i.ibb.co/ssQK19S/coat.jpg',
        'InActive'
    );
